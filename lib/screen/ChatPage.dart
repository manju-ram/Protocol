...
//numbers
  ...
  void commandInitialize() {
    ...
    despritionTagCMDTemp = preamble + despritionTagCMD + despritionTagCMDChecksum + lastValue;
    ...
    upperlimitlowerTagCMDTemp = preamble + upperlimitlowerTagCMD + upperlimitlowerTagCMDChecksum + lastValue;
    ...
    outerHighCMDTemp = preamble + outerHighCMD + outerHighCMDChecksum + lastValue;
    ...
    automaticControlTemp = preamble + automaticControl + automaticControlChecksum + lastValue;
    outerLowCMDModification = [0x82] + macaddress + Command.outerLowCMDModification;
    outerLowCMDModificationSecond = [0x82] + macaddress + Command.outerLowCMDModificationSecond;
